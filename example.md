...
layout: cover
class: text-white
coverAuthor: [fz68, contributors]
coverAuthorUrl: [https://github.com/fz68, https://github.com/fz68/slidev-theme-academic-zju/graphs/contributors]
...
fonts:
  local: Montserrat, Roboto Mono, Roboto Slab # local fonts are used for legal reasons for deployment to https://github.com/fz68/slidev-theme-academic-zju and only set up for the example project, remove this line for your project to automatically have fonts imported from Google
hideInToc: true
themeConfig:
  paginationX: r
  paginationY: t
  paginationPagesDisabled: [1]
title: slidev-theme-academic-zju
info: |
  # slidev-theme-academic-zju

  Created and maintained by [fz68](https://github.com/fz68).

  - [GitHub](https://github.com/fz68/slidev-theme-academic-zju)
  - [npm](https://www.npmjs.com/package/slidev-theme-academic-zju)

  slidev-theme-academic-zju is licensed under [MIT](https://github.com/fz68/slidev-theme-academic-zju/blob/master/LICENSE).
---
...
layout: index
indexEntries:
  - { title: "GitHub", uri: "https://github.com/fz68/slidev-theme-academic-zju" }
  - { title: "npm", uri: "https://www.npmjs.com/package/slidev-theme-academic-zju" }
